...
class TicTacToeGUI(Tk):
    def __init__(self, user, ai, score):
        ...
        self.field_1 = field(self.root, 200, 200, 0, 0, self, 0)
        self.field_2 = field(self.root, 200, 200, 1, 0, self, 1)
        self.field_3 = field(self.root, 200, 200, 2, 0, self, 2)
        self.field_4 = field(self.root, 200, 200, 0, 1, self, 3)
        self.field_5 = field(self.root, 200, 200, 1, 1, self, 4)
        self.field_6 = field(self.root, 200, 200, 2, 1, self, 5)
        self.field_7 = field(self.root, 200, 200, 0, 2, self, 6)
        self.field_8 = field(self.root, 200, 200, 1, 2, self, 7)
        self.field_9 = field(self.root, 200, 200, 2, 2, self, 8)
